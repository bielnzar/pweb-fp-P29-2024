    ...
    <main class="flex-grow container mx-auto py-8">
      ...
      <div class="bg-white shadow-lg rounded-lg p-6">
        ...
        <div class="flex flex-wrap justify-between items-center mt-4">
          <div class="space-x-2 flex flex-wrap justify-center sm:justify-start">
            <button 
              @click="prevPage" 
          ...
          <div class="flex items-center space-x-2 mt-2 sm:mt-0">
            ...
            <input 
              ...
              min="1" 
              :max="totalPages" 
              class="w-16 sm:w-24 border border-gray-300 rounded-md px-2 py-1 text-center text-sm"
              placeholder="Page"
            />
            <button 
              @click="goToPage"
          ...
          <button 
            @click="showAll" 
            class="bg-blue-600 text-white py-1 px-4 rounded-md hover:bg-blue-700 transition duration-300 mt-4 sm:mt-0"
          >
            Show All
          </button>
        </div>
